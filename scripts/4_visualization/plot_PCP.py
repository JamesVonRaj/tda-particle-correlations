...
# 'cluster_radius' is now 'cluster_std_dev' ($r_0$)
BASE_PARAMS = {
    'lambda_parent': 0.1,
    'lambda_daughter': 30,
...
# --- Define our 4 scenarios ---
# 1. Baseline
params_1 = BASE_PARAMS.copy()
title_1 = f"Baseline:\nParent={BASE_PARAMS['lambda_parent']}, Daughter={BASE_PARAMS['lambda_daughter']}, StdDev={BASE_PARAMS['cluster_std_dev']}"
label_1 = "Baseline"

# 2. More Clusters (Increase LAMBDA_PARENT)
params_2 = BASE_PARAMS.copy()
params_2['lambda_parent'] = 0.5 # 5x more clusters
title_2 = f"High LAMBDA_PARENT:\nParent={params_2['lambda_parent']}, Daughter={params_2['lambda_daughter']}, StdDev={params_2['cluster_std_dev']}"
label_2 = "High $\\rho_P$ (More Clusters)"

# 3. Denser Clusters (Increase LAMBDA_DAUGHTER)
params_3 = BASE_PARAMS.copy()
params_3['lambda_daughter'] = 100 # ~3.3x more points per cluster
title_3 = f"High LAMBDA_DAUGHTER:\nParent={params_3['lambda_parent']}, Daughter={params_3['lambda_daughter']}, StdDev={params_3['cluster_std_dev']}"
label_3 = "High $c$ (Denser Clusters)"

# 4. Tighter Clusters (Decrease CLUSTER_STD_DEV)
params_4 = BASE_PARAMS.copy()
params_4['cluster_std_dev'] = 0.2 # 1/3 the standard deviation
title_4 = f"Low CLUSTER_STD_DEV ($r_0$):\nParent={params_4['lambda_parent']}, Daughter={params_4['lambda_daughter']}, StdDev={params_4['cluster_std_dev']}"
label_4 = "Low $r_0$ (Tighter Clusters)"
...
if __name__ == "__main__":
    ...
    # --------------------------------------------------------------------------
    print("Generating parameter comparison plot (Thomas Process)...")
    ...
    fig.suptitle("How Thomas Cluster Parameters Affect the Process", fontsize=16, y=0.98)
    plt.tight_layout(rect=[0, 0.03, 1, 0.95])
    
    # Save or show the plot
    figname = "cluster_parameter_comparison_thomas.png"
    ...
    ax_g2.set_title("Theoretical Pair Correlation Function $g_2(r)$", fontsize=16)
    ...
    figname_g2 = "cluster_g2_comparison_thomas.png"
    ...
    ax_sk.set_title("Theoretical Structure Factor $S(k)$", fontsize=16)
    ...
    figname_sk = "cluster_sk_comparison_thomas.png"
